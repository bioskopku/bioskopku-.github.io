...
var fetchUrl = api+'/search/movie?api_key='+kunci+'&language=id-ID&query='+q+'&page='+page;
	let dataNews = '<table><tr><th class="left"><h3>Query by <span style="color:#fff;">'+q+'</span> Page: <span style="color:#fff;">'+page+'</span></h3></th><th class="right"><h3><a href="popular.html">Most Popular</a> | <a href="toprated.html">Top Rated</a> | <a href="trending.html">Trending</a></h3></th></tr></table>';
	fetch(fetchUrl)
