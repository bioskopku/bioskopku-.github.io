...
function getDataRender() {
	...
	.then(data => { console.log(data)
		...
		rendered += '<div class="embed"><div class="iframe-container"><iframe class="lazyload" data-src="https://2embed.biz/embed/movie?imdb='+embed+'&server=hydrax"></iframe></div></div>';
