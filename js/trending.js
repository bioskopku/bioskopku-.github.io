...
var fetchUrl = api+'/trending/movie/day?api_key='+kunci+'&language=id-ID&page='+page;
	let dataNews = '<table><tr><th class="left"><h3>Trending Movies Page: <span style="color:#fff;">'+page+'</span></h3></th><th class="right"><h3><a href="popular.html">Most Popular</a> | <a href="toprated.html">Top Rated</a> | Trending</h3></th></tr></table>';
	fetch(fetchUrl)
