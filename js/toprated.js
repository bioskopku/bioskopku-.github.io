...
var fetchUrl = api+'/movie/top_rated?api_key='+kunci+'&language=id-ID&page='+page;
	let dataNews = '<table><tr><th class="left"><h3>Top Rated Movies Page: <span style="color:#fff;">'+page+'</span></h3></th><th class="right"><h3><a href="popular.html">Most Popular</a> | Top Rated | <a href="trending.html">Trending</a></h3></th></tr></table>';
	fetch(fetchUrl)
