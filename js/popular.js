...
var fetchUrl = api+'/movie/popular?api_key='+kunci+'&language=id-ID&page='+page;
	let dataNews = '<table><tr><th class="left"><h3>Popular Movies Page: <span style="color:#fff;">'+page+'</span></h3></th><th class="right"><h3>Most Popular | <a href="toprated.html">Top Rated</a> | <a href="trending.html">Trending</a></h3></th></tr></table>';
	fetch(fetchUrl)
