if (page >= 2){
var page=page;
var prevPage = '<a href="?q='+q+'&page='+(page*1-1)+'"><i class="fa fa-chevron-left"></i> PREV</a>';
var nextPage = '<a href="?q='+q+'&page='+(page*1+1)+'">NEXT <i class="fa fa-chevron-right"></i></a>';
}else{
var page=1
var prevPage = '';
var nextPage = '<a href="?q='+q+'&page='+(page*1+1)+'">NEXT <i class="fa fa-chevron-right"></a>';
}
document.addEventListener("DOMContentLoaded", function() { getDataNews(); })
function getDataNews() {
var fetchUrl = api+'/discover/movie?primary_release_year='+q+'&api_key='+kunci+'&language=id-ID&page='+page;
	let dataNews = '<table><tr><th class="left"><h3>Movies from <span style="color:#fff;">'+q+'</span> Page: <span style="color:#fff;">'+page+'</span></h3></th><th class="right"><h3><a href="popular.html">Most Popular</a> | <a href="toprated.html">Top Rated</a> | <a href="trending.html">Trending</a></h3></th></tr></table>';
	fetch(fetchUrl)
